    ...
    <section className="min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        <div className="text-center">
          ...
          <Link
            target="_blank"
            href="https://aistudio.google.com/apikey?_gl=1*1958ttx*_ga*MTc1MDMzODkyNS4xNzQxODAxNjEx*_ga_P1DBVKWT6V*MTc0MTgwMTYxMS4xLjAuMTc0MTgwMTYxMi41OS4wLjUwNzQ0NTgwMw.."
            className=" text-sm font-medium inline-block mb-8 underline"
          >
            Before Starting Get Your Gemini AI API Key here
          </Link>
